    ...
    with open(nombre_archivo, 'w') as f:
        with open(nombreDynamicOutput, 'w') as fOut:
            ...
            for i in range(n):
                ...
                particles_position.append(valorX)

            particles_position.sort()
            for i in range(n):
                f.write(f"{particles_position[i]} {particles_position[i]} {u_array[i]}\n")
                fOut.write(f"{particles_position[i]} {particles_position[i]} {u_array[i]}\n")
